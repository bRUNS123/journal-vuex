<template>
  ...
  <Fab icon="fa-save"/>
  <img src="https://www.rockandpop.cl/wp-content/uploads/2018/07/invasor-zim-768x512.jpg" alt="entry-picture" class="img-thumbnail">
</template>
...
img {
  ...
  bottom: 150px;
  right: 50px;
  box-shadow: 0px 5px rgba($color: #000, $alpha: 0.2);
}
